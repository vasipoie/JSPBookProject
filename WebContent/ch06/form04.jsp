                    ...
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<form action="form04_process.jsp" name="member" method="post">
							...
							<!-- 
								...
								wrap = "hard"속성을 사용 시, clos 속성이 꼭 명시되어 있어야 합니다
								
								wrap속성의 값을 soft, hard로 설정 시 textarea 설정 크기 안에서
								Enter를 치지 않고 텍스트를 입력해 나갈 때, textarea 가로 길이 오른쪽
								맨 끝에 다다를 때 자동으로 아래줄로 넘어가 작성이 되는데 이 때,
								Enter를 직접 치지는 않았지만 아래줄로 내려가 작성됩니다.
								
								이때, hard는 개행 문자가 포함된 데이터가 전송된다.
								(개행문자인 '\n\r'과 같은 데이터상에 보여지지는 않지만,
								데이터를 확인해보면 Enter가 쳐진 상태의 데이터를 확인할 수 있음)
							 -->
							<p>
