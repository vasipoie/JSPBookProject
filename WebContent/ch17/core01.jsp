            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						<!-- 내용을 입력해주세요 -->
						<!-- 
							JSTL(JSP Standard Tag Library)은 JSP 페이지에서 스크립트 요소로 인한
							코드의 복잡성을 해결하기 위한 일종의 사용자 정의 태그의 표준입니다.
							
							JSP페이지에 JSP의 스크립트 요소의 HTML 코드를 혼용하면 편리하게 개발할 수 있으나
							코드의 복잡성이 증가되는 것이 문제입니다.
							따라서 JSP페이지의 로직을 담당하고 있는 if, for, while 등등과 관련된 코드를
							JSTL로 대치하여 코드를 깔끔하고 가독성 있는 프로그래밍이 가능하게 한다.
							
							request.getHeader("User-Agent");
							request 내장객체를 이용하여 가져온 header
						...
						userAgent : <c:out value="${userAgent }"></c:out>
                    </div>
                </div>
            </div>
        </div>
