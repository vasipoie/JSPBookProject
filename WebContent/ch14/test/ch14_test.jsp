                    ...
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<!-- 
						 ...
						 <%
						 	...
						 	String idCheck = request.getParameter("cookieIdCheck");
						 	...
						 	for(int i=0; i<cookies.length; i++){
						 		...
						 		if(n.equals("cookieId")){
						 			id = URLDecoder.decode(thisCookie.getValue(), "UTF-8");
						 		}
						 		if(n.equals("cookieIdCheck")){
						 			check = URLDecoder.decode(thisCookie.getValue(), "UTF-8");
						 		}
						 	}
						 %>
						...
						%>
									...
									<p>비밀번호 : <input type="text" name="pw"/></p>
									<p><input type="checkbox" value="idStore" name="idCheck" >아이디 저장</input></p>
						<%
							  	}
						%>
