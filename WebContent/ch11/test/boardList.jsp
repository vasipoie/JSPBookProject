                ...
                <div class="col-lg-12 col-md-12 col-12">
					...
					<!-- 
					 ...
					 %>
					 	<h5>메뉴 박스</h5>
					 	<hr />
					 	<a href="boardList.jsp"><button>게시판</button></a> <a href="dropbox.jsp"><button>자료실</button></a> <a href="logout.jsp"><button>로그아웃</button></a>
					 	<hr />
						...
						<a href="boardForm.jsp"><button>등록</button></a>
                    </div>
                </div>
            </div>
        </div>
