...
<!-- 
	현재 JSP 페이지에서 오류가 발생하면 오류 페이지로 이동하기 위해 page 디렉티브 태그의
	errorPage 속성을 작성
-->
<!DOCTYPE html>
                ...
                <div class="col-lg-12 col-md-12 col-12">
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<%
							...
							// 서버에러로 인한 500코드, NullPointerException이 발생하여
							// 브라우저 화면상에서의 500에러 페이지가 나타나야 하지만,
							// out.println(str.toString()); 에서 발생한 에러를 브라우저에서
							// 제대로 된 소스로 인식하지 않고 완전하지 않은 소스라고 분류하며
							// 에러가 난 시점에서 브라우저 상의 화면 그리기를 멈추고
							// 아래와 같은 에러를 발생시킬 수 있습니다.
							// "to load resource : net::ERR_IMCOMPLETE_CHUNKED_ENCODING"
							// - 여러가지 상황에서 의해서 발생할 수 있는 에러로,
							//   페이지를 그려낼 때 완전하지 못한 소스가 존재할 경우 발생한다.
